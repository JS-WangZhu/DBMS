...
function clearState() { clearTimers(); probeToken.value = ""; expiresAt.value = null; remainingSeconds.value = 0; sessions.value = []; hiddenIds.value = new Set(); collectedAt.value = null; canKill.value = false; refreshQueued = false; }
