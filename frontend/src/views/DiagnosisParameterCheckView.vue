  ...
  <div class="page">
    ...
    <el-card shadow="never" class="content-card">
      ...
      <el-table v-loading="loading" :data="rows" stripe>
        ...
        <el-table-column label="参数数" width="90"><template #default="scope">{{ scope.row.latest?.parameter_count ?? "-" }}</template></el-table-column>
