...
MENU_CATALOG = [
    ...
    {"key": "mysql_instance_detail", "label": "MySQL 实例详情"},
    ...
    {"key": "redis_instance_detail", "label": "Redis 实例详情"},
    ...
    {"key": "sql_release_config", "label": "数据发布配置"},
    {"key": "ha_config", "label": "高可用配置管理"},
    {"key": "instance_status_config", "label": "实例状态检测管理"},
    {"key": "inspection_param_config", "label": "巡检参数"},
